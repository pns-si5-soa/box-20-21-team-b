export const PORT = process.env.PORT ? process.env.PORT : 3004;
...
export const PROBE_PORT = process.env.PROBE_PORT ? process.env.PROBE_PORT : 3003
export const STAGE_HOST = process.env.STAGE_HOST ? process.env.STAGE_HOST : "localhost"
export const STAGE_PORT = process.env.STAGE_PORT ? process.env.STAGE_PORT : 3003
export const BOOSTER_HOST = process.env.BOOSTER_HOST ? process.env.BOOSTER_HOST : "localhost"
export const BOOSTER_PORT = process.env.BOOSTER_PORT ? process.env.BOOSTER_PORT : 3003
