...
export const MISSION_PORT = process.env.MISSION_PORT ? process.env.ROCKET_PORT : 3002;

export const WEATHER_HOST = process.env.WEATHER_HOST ? process.env.WEATHER_HOST : 'localhost';
export const MISSION_HOST = process.env.MISSION_HOST ? process.env.ROCKET_HOST : 'localhost';
