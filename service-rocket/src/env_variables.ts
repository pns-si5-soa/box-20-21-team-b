...
export const MODULES_HOST = process.env.MODULES_HOST ? process.env.PROBE_HOST : "localhost"
export const MODULES_PORT = process.env.MODULES_PORT ? process.env.PROBE_PORT : 3015
